...
/*!40000 ALTER TABLE `places`
    DISABLE KEYS */;
INSERT INTO `places`
VALUES (1, 'Central Park', '123 Park Ave, City', 'P1001', 1),
       ...
       (11, 'ILERNA Barcelona - Centro de Formación Profesional',
        'Carrer de Santa Carolina, 1, Horta-Guinardó, Barcelona', '08025', 1);
/*!40000 ALTER TABLE `places`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'Alice', 'Smith', 'alice@example.com', 'hashedpassword1', '123 Maple Street, New York, NY', 1,
       ...
       (16, 'Gustavo', 'Gonzales', 'gusgonza@yowpet.com', '$2a$10$d1IvTvb1nym6KzD.L/Crh.iKuD3rrNbbihzkJ00mSHRevroqTLBCa',
        'No especificado', 2, '', '', _binary 'No especificado', 1, '0', NULL, NULL, NULL, NULL, 'No especificado',
        NULL, NULL, '2025-04-10 17:28:23', '2025-04-10 17:28:23', NULL, 'Mano',
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJndXNnb256YUBnbWFpbC5jb20iLCJ1c2VySWQiOjE4LCJpYXQiOjE3NDcwMDAxNzAsImV4cCI6MTc0NzAwMzc3MH0.0pjRLWXA_CxeHD0Cwg6FLdv67Gjd44k6v1QnXB6WcQw');
/*!40000 ALTER TABLE `users`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-22 16:57:01
