        ...
        >
          <TouchableOpacity style={styles.imageUpload} onPress={pickImage}>
            {petData.profilePicture ? (
              ...
              <Ionicons name="camera" size={40} color={YowPetTheme.text.secondaryText} />
            )}
          </TouchableOpacity>
          ...
          >
            <Text style={styles.selectorText}>
              {petData.animalCategory ?
                ANIMAL_CATEGORIES.find(c => c.id === petData.animalCategory)?.name || 'Seleccionar tipo de mascota *' :
          ...
          {petData.animalCategory !== '' && petData.animalCategory !== 0 && (
            ...
            >
              <Text style={styles.selectorText}>
                {petData.breed ?
                  getBreedOptions().find(b => b.id === petData.breed)?.name || 'Seleccionar raza' :
                  'Seleccionar raza'}
              </Text>
              <Ionicons name="chevron-down" size={24} color={YowPetTheme.text.subtleText} />
            </TouchableOpacity>
