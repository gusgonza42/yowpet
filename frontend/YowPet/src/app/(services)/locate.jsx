                            ...
                            {pets.map(pet => (
                                ...
                                >
                                    <View style={[
                                        ...
                                        pet.status === 'lost' ? styles.lostMarker : styles.foundMarker
                                    ]}>
                        ...
                        <TouchableOpacity key={pet.id} style={styles.petCard}>
                            ...
                            <View style={styles.petInfo}>
                                <View style={styles.petHeader}>
                                    ...
                                    <View style={[
                                        styles.statusBadge,
                                        pet.status === 'lost' ? styles.lostBadge : styles.foundBadge
                                    ]}>
                                ...
                                <Text style={styles.lastSeen}>Visto por última vez: {pet.lastSeen}</Text>
                                <View style={styles.locationContainer}>
                                    <Ionicons name="location" size={16} color={YowPetTheme.brand.primary} />
                                    <Text style={styles.locationText}>Cerca de Plaza Catalunya</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    ))}
