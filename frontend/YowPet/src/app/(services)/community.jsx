        ...
        <ScreenContainer backgroundColor={YowPetTheme.brand.primary}>
            <View style={styles.contentContainer}>
                <View style={styles.header}>
                    ...
                    <TouchableOpacity>
                        <Ionicons name="notifications" size={24} color={YowPetTheme.text.mainText} />
                    </TouchableOpacity>
                </View>
                            ...
                            {communityData.featuredGroups.map(group => (
                                <TouchableOpacity key={group.id} style={styles.groupCard}>
                                    ...
                                    <View style={styles.groupInfo}>
                                        ...
                                        <Text style={styles.groupMeta}>{group.members} miembros • {group.category}</Text>
                                    </View>
                                </TouchableOpacity>
                            ))}
                        </ScrollView>
                        ...
                        <View style={styles.categoriesContainer}>
                            {communityData.popularCategories.map(category => (
                                <TouchableOpacity key={category.id} style={styles.categoryCard}>
                                    <Ionicons name={category.icon} size={28} color={YowPetTheme.brand.primary} />
                            ...
                            <View key={post.id} style={styles.postCard}>
                                ...
                                <View style={styles.postActions}>
                                    <TouchableOpacity style={styles.actionButton}>
                                        <Ionicons name="heart-outline" size={20} color={YowPetTheme.text.subtleText} />
                                        <Text style={styles.actionText}>{post.likes}</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.actionButton}>
                                        <Ionicons name="chatbubble-outline" size={20} color={YowPetTheme.text.subtleText} />
